...
export async function loadEmployees() {
    await runLoader('Employees', async () => {
        ...
        await bulkLoad('Employees', [
            { name: 'id',            mappedName: 'Employee Id',    type: sql.Int, options: { nullable: false, primary: true } },
            { name: 'number',        mappedName: 'Employee Num',   type: sql.NVarChar(20) },
            ...
            { name: 'payGroupId',    mappedName: 'Pay Group Id',   type: sql.Int          },
            { name: 'departmentId',  mappedName: 'Department Num', type: sql.Int          },
